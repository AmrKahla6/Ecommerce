                        ...
                        <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            @permission('dash_change_status_0f_review')
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" blog="menu">
                                                        ...
                                                        <li>
                                                            <a class="delete_btn" data-id="{{ $review->id }}" data-toggle="modal" data-target="#active_modal">
                                                                <i class="fa fa-trash"></i> {{ __('active') }} </a>
                                                        </li>
                                                      
                                                    
                                                        <li>
                                                            <a class="delete_btn" data-id="{{ $review->id }}" data-toggle="modal" data-target="#block_modal">
