...
@endsection
@section('content')
<form role="form" class="form-horizontal" method="POST" action="{{route('save_home_section_1')}}"  enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="form-body">
        @component('input_trans', ['type' => 'text', 'label' => 'title', 'required' => false])
            title
        @endcomponent
        @component('input_trans', ['type' => 'text', 'label' => 'description', 'required' => false])
            description
        @endcomponent
        @component('input_trans', ['type' => 'text', 'label' => 'button', 'required' => false])
            button
        @endcomponent
        ...
        @component('input_image', ['width' => 1400, 'height' => 300, 'label' => 'Image', 'src' => route('image_show')])
            image
        @endcomponent
