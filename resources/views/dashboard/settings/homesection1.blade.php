    ...
    <div class="row">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{ route('create_home_section_1') }}"  class="btn btn-primary"> {{ __('Add New')}}
                ...
                <div class="box-body">
                    <table class="table table-striped table-bordered" id="example1">  
                        ...
                        <tbody>
                            @forelse ($homesection1s as $homesection1)
                            <tr>
                                <td> {{ $homesection1->id }} </td>
                                <td> {{ $homesection1->title }} </td>
                                <td> {{ $homesection1->description }} </td>
                                <td> {{ $homesection1->type }} </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" subcategory="menu">
                                            <li>
                                                <a href="{{ route('edit_home_section_1', $homesection1->id) }}">
                                                    <i class="fa fa-pencil-square-o"></i> {{ __('Edit') }} </a>
                                            </li>
                                            <li>
                                                <a class="delete_btn" data-id="{{ $homesection1->id }}" data-toggle="modal" data-target="#delete_modal">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="delete_form" method="POST" action="{{ route('delete_home_1', 0) }}">
                    @csrf
                    @method('DELETE')
