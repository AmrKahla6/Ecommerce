    ...
    <div class="row">
            <div class="box">
                ...
                <form id="delete_form" method="POST" action="{{ route('create_helps') }}">
                        @csrf
                        <input type="hidden" value="track_order" name="type">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" subcategory="menu">
                                            <li>
                                                <form id="delete_form" method="POST" action="{{ route('save_edit_helps',$value->id) }}">
                                                    @csrf
                                                    <input type="hidden" value="track_order" name="type">
