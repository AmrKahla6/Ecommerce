                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            <h2 class="title__line">{{trans('all_products.No Products Exist')}}</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="htc__product__container">
                            ...
                            <div class="filter__menu__container">
                                <div class="product__menu">
									...
									@foreach($category->subcategories as $subcategory)
										<button data-filter=".cat--{{ $subcategory->id }}">{{ $subcategory->name }}</button>
									@endforeach
                                </div>
                    ...
                    <div class="filter__wrap">
                        <div class="filter__cart">
                            <div class="filter__cart__inner">
                                ...
                                <form method="get" action="{{ route('all_products',$category->id) }}">
                                    <!-- Start Single Content -->
                                    <div class="fiter__content__inner">

                                        <div class="single__filter" style="width:100%">
                                            <h2 class="title__5"></h2>
                                            <div class="row">
                                                <div class="col-6">
                                                        ...
                                                        <li>
                                                            <div class="pretty p-icon p-round">
                                                                ...
                                                                <div class="state p-success">
                                                                    ...
                                                                    <label>{{trans('all_products.price low to high')}}</label>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="single__filter" style="width:100%">
                                            <h2>{{trans('all_products.Price')}}</h2>
                                            <div class="row">
                                                <div class="col-6">
                                                    <ul class="filter__list">
                                                    <div  class="news__input">
                                                        <input type="number" value="{{ request('from')   ? request('from') : '' }}" name="from"  id="from" placeholder="{{trans('all_products.price from')}}" >
                                                    </div>
                                                    </ul>
                                                </div>
                                                <div class="col-6">
                                                    <ul class="filter__list">
                                                    <div class="news__input">
                                                        <input type="number" value="{{ request('to')   ? request('to') : '' }}" name="to" id="to" placeholder="{{trans('all_products.price to')}}" >
                                                    </div>
                                                    </ul>
                                                </div>
                                            </div>
                                       ...
                                       ?>
                                        <div class="single__filter" style="width:100%">
                                            <h2 class="title__5">{{trans('all_products.Size')}}</h2>
                                        ...
                                        <div class="single__filter" style="width:100%">
                                            <h2 class="title__5">{{trans('all_products.Color')}}</h2>
                                            <div class="row">
                                            <div class="col-4">
                                                    <ul class="filter__list">
                                    ...
                                    <button  type="submit" style="width:40%;margin-right:20px"> <a style="width:100%" >{{trans('all_products.Search')}} </a> </button>
                                    <button style="width:40%"> <a href="{{ route('all_products',$category->id) }}" style="width:100%" >{{trans('all_products.Reset')}} </a> </button>
                                    </div>
                                    <div class="store__btn" >
                    ...
                    <?php $all_ids_products=[];?>
                        ...
                        <div class="col-md-4 single__pro col-lg-3 cat--{{ $product->subcategory->id }} col-sm-12" style="margin-left:auto; margin-right:0;">
